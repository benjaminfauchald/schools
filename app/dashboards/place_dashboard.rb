...
class PlaceDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    id: Field::Number,
    address_components: Field::String.with_options(searchable: false),
    amenities: Field::String.with_options(searchable: false),
    api_status: Field::String,
    business_status: Field::String,
    current_opening_hours: Field::String.with_options(searchable: false),
    editorial_summary: Field::Text,
    error_message: Field::Text,
    formatted_address: Field::Text,
    formatted_phone_number: Field::String,
    geometry_data: Field::String.with_options(searchable: false),
    ...
    name: Field::String,
    opening_hours: Field::String.with_options(searchable: false),
    ...
    raw_api_response: Field::String.with_options(searchable: false),
    reference: Field::String,
    reviews: Field::String.with_options(searchable: false),
    scope: Field::String,
    secondary_opening_hours: Field::String.with_options(searchable: false),
    types: Field::String.with_options(searchable: false),
    url: Field::String,
